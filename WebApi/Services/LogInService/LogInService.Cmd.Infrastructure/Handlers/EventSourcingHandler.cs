...
{
    public class EventSourcingHandler : IEventSourcingHandler<LogInAggregate>
    {
        ...
        public async Task<LogInAggregate> GetByIdAsync(Guid aggregateId, bool eventSouringEnabled)
        {
            var aggregate = new LogInAggregate(_httpContextAccessor);
