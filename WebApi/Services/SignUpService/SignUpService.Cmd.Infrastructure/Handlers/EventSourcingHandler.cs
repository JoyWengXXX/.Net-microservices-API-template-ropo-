...
{
    public class EventSourcingHandler : IEventSourcingHandler<SignUpAggregate>
    {
        ...
        public async Task<SignUpAggregate> GetByIdAsync(Guid aggregateId, bool eventSouringEnabled)
        {
            var aggregate = new SignUpAggregate(_httpContextAccessor);
