...
{
    public class EventSourcingHandler : IEventSourcingHandler<RoleAggregate>
    {
        ...
        public async Task<RoleAggregate> GetByIdAsync(Guid aggregateId, bool eventSouringEnabled)
        {
            var aggregate = new RoleAggregate(_httpContextAccessor);
